	...
	$(function(){
		if($(window).width()<568){
			...
			$("#menu-img1").each(function(){
				$(this).attr("src", $(this).attr("src").replace("images/2900 x 2003/pasta_1.jpg","images/2300x3200/pasta_4.jpg"));
			});
			...
			$("#menu-img1").each(function(){
				$(this).attr("src", $(this).attr("src").replace("images/2300x3200/pasta_4.jpg","images/2900 x 2003/pasta_1.jpg"));
			});
